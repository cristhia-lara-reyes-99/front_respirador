...
const MindfulBreathingApp = () => {
  ...
  const AnswerButton = ({ color, label, onClick }) => (
    <button
      onClick={onClick}
      className={`w-full h-24 px-4 rounded-full text-white transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-opacity-50 flex items-center justify-center ${
        color === 'light'
      ...
      <div className={`fixed inset-y-0 right-0 transform ${isSideMenuOpen ? 'translate-x-0' : 'translate-x-full'} ${darkMode ? 'bg-gray-800' : 'bg-white'} w-64 transition duration-300 ease-in-out z-30 side-menu`}>
        <div className="p-6 flex flex-col h-full">
          ...
          <div className="space-y-4 flex-grow">
            <button 
              ...
              className={`w-full px-4 py-2 rounded-full text-sm transition-colors duration-300 ${
                darkMode ? 'bg-blue-700 hover:bg-blue-600 text-white' : 'bg-blue-300 hover:bg-blue-400 text-gray-800'
              }`}
            >
            ...
            <button
              ...
              className={`w-full px-4 py-2 rounded-full text-sm transition-colors duration-300 ${
                darkMode ? 'bg-blue-500 hover:bg-blue-400 text-white' : 'bg-blue-500 hover:bg-blue-600 text-white'
              }`}
            >
            ...
            <button 
              ...
              className={`w-full px-4 py-2 rounded-full text-sm transition-colors duration-300 ${
                darkMode ? 'bg-blue-300 hover:bg-blue-200 text-gray-800' : 'bg-blue-700 hover:bg-blue-800 text-white'
              }`}
            >
              {t.info}
            </button>
          ...
          <button
            ...
            className={`w-full mt-auto px-4 py-2 rounded-full text-sm transition-colors duration-300 ${
              darkMode ? 'bg-blue-300 hover:bg-blue-200 text-gray-800' : 'bg-blue-700 hover:bg-blue-800 text-white'
            }`}
          >
            {t.takeQuiz}
        ...
        <div className="flex flex-col items-center justify-center min-h-screen">
          ...
          <div className="relative mb-4">
            <select 
              ...
              className={`appearance-none w-full px-4 py-2 pr-8 rounded-full border ${
                darkMode 
          ...
          {technique === 'alternateNostril' ? (
            <div className="w-64 h-64 rounded-full flex flex-col items-center justify-center mb-8 bg-blue-500 shadow-lg relative overflow-hidden">
              ...
              <div className={`absolute right-0 top-1/2 transform -translate-y-1/2 w-8 h-8 ${
                phase.includes('hold') || 
          ...
          <div className="flex space-x-4">
            <button
              ...
              className={`px-6 py-3 rounded-full text-base font-medium text-white transition-colors duration-300 ${
                isActive ? 'bg-red-500' : (isCompleted ? 'bg-green-500' : 'bg-blue-500')
              }`}
            >
